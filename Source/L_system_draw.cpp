...
// L_system_draw.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CL_system_drawApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CL_system_drawApp

CL_system_drawApp::CL_system_drawApp()
{
...
// Единственный объект CL_system_drawApp

CL_system_drawApp theApp;


// инициализация CL_system_drawApp

BOOL CL_system_drawApp::InitInstance()
{
